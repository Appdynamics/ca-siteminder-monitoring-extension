...
public class ThreadPool implements WorkerPool {
  ...
  /**
   * Handle a interrupted exception on the execution attempt of {@link WorkerTask}.
   ...
   * if {@link SNMP4JSettings#forwardRuntimeExceptions} is <code>true</code>. Otherwise, the
